...
export default function Minute({ page, go, offers, createOrder }) {
  ...
  const minuteOffers = useMemo(() => {
    return offers.filter(
      (item) => item.type === "minute" && item.operator === operator
    );
  }, [offers, operator]);
  ...
  function confirmOrder() {
    if (!orderNumber) {
      showMessage("error", "নাম্বার দিন", "যে নাম্বারে মিনিট প্যাক নিবেন, সেই নাম্বার লিখুন");
      return;
    }
    ...
    showMessage("success", "অর্ডার হয়েছে", "Minute Pack order pending হয়েছে", "statement");
  }

  return (
    <div className="mobileApp">
      <PageHeader title="মিনিট প্যাক" go={go} />
      ...
      <div className="offerList">
        {minuteOffers.length === 0 ? (
          <div className="emptyBox">এই অপারেটরে এখন কোনো মিনিট অফার নেই</div>
        ) : (

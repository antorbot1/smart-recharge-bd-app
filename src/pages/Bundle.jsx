...
export default function Bundle({ page, go, offers, createOrder }) {
  ...
  const bundleOffers = useMemo(() => {
    return offers.filter(
      (item) => item.type === "bundle" && item.operator === operator
    );
  }, [offers, operator]);
  ...
  function confirmOrder() {
    if (!orderNumber) {
      showMessage("error", "নাম্বার দিন", "যে নাম্বারে বান্ডেল প্যাক নিবেন, সেই নাম্বার লিখুন");
      return;
    }
    ...
    showMessage("success", "অর্ডার হয়েছে", "Bundle Pack order pending হয়েছে", "statement");
  }

  return (
    <div className="mobileApp">
      <PageHeader title="বান্ডেল প্যাক" go={go} />
      ...
      <div className="offerList">
        {bundleOffers.length === 0 ? (
          <div className="emptyBox">এই অপারেটরে এখন কোনো বান্ডেল অফার নেই</div>
        ) : (
